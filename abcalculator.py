...
def popup_window(n1, c1, n2, c2):
    ...
    txt_output.place(x=15, y=105, width=470, height=330)
    ...
    lbl_comments95 = tk.Label(window, text= "95% уверенность:", font=('Helvetica', 10, 'bold'), bg='#8fffff')
    lbl_comments95.place(x=25, y=25)

    if confidence_95:
        lblResult95 = tk.Label(window, text="Да", font=('Helvetica', 12, 'bold'), fg='#008800', bg='#8fffff')
        lblResult95.place(x=160, y=25)
    else:
        lblResult95 = tk.Label(window, text="Нет", font=('Helvetica', 12, 'bold'), fg='#ff0000', bg = '#8fffff')
        lblResult95.place(x=160, y=25)

    lbl_comments99 = tk.Label(window, text="99% уверенность:", font=('Helvetica', 10, 'bold'), bg='#8fffff')
    lbl_comments99.place(x=25, y=65)
    if confidence_99:
        lblResult99 = tk.Label(window, text="Да", font=('Helvetica', 12, 'bold'), fg='#008800', bg='#8fffff')
        lblResult99.place(x=160, y=65)
    else:
        lblResult99 = tk.Label(window, text="Нет", font=('Helvetica', 12, 'bold'), fg='#ff0000', bg='#8fffff')
        lblResult99.place(x=160, y=65)
